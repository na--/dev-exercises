...
fn test_simple_functions() {
    ...
    assert_eq!(
        Polynomial::from(vec![0.0, 1.0]),
        Polynomial::from(vec![1.0])
    );
    assert_eq!(
...
fn test_interpolation() {
    assert_eq!(
        Polynomial::interpolate(vec![(1.0, 1.0), (1.0, 4.0), (3.0, 9.0)]),
        None
    );
    assert_eq!(
        Polynomial::interpolate(vec![(1.0, 1.0), (2.0, 4.0), (3.0, 9.0)]).unwrap(),
        Polynomial::from(vec![1.0, 0.0, 0.0])
    );
    assert_eq!(
        Polynomial::interpolate(vec![(1.0, 1.0), (2.0, 8.0), (3.0, 27.0)]).unwrap(),
